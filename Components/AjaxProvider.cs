        ...
        public override string ProcessCommand(string paramCmd, HttpContext context, string editlang = "")
        {
            ...
            switch (paramCmd)
            {
                ...
                case "nbrightsystempay_selectlang":
                    ...
                    strOut = NBrightBuyUtils.RazorTemplRender("settingsfields.cshtml", 0, "", info, "/DesktopModules/NBright/NBrightSystemPay", "config", nextlang, StoreSettings.Current.Settings());
                    break;                                        
            }
